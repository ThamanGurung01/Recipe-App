...
if(recipeName!=""&&ingredients!=""&&instruction!=""){
  ...
  return (
    <div className={!Edit?"m-2 border-4 bg-gray-200 shadow-xl rounded-lg lg:w-80 md:w-72 xl:w-96":""}>
      <form className='flex flex-col pl-3 mt-2'>
      ...
      <button type='button' className="self-center mb-2 w-28 btn-primary hover:btn-add-hover" onClick={StoreData}>{!Edit?"Submit":"Update"}</button>
      </form>  
    </div>
  )
}
